...
// Computes all Government-mandated deductions, 
public final class DeductionCalculator {
   ...
   // Computes withholding tax based on taxable income (gross pay minus statutory deductions).
// Benefits are excluded from taxable computation.
