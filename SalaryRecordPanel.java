...
import java.util.List;
 ...
 //Never instantiated. build() wires the "Salary Record" tab  
 // view-only lookup of an employee's computed salary details for a
 // chosen month/year. No data is saved from this panel.
