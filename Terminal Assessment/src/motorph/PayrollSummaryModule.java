...
import java.util.List;
 ...
 // Feature 5 — Company-wide Payroll Summary.
 // Reuses DeductionCalculator and BenefitsCalculator from Feature 3.
...
public final class PayrollSummaryModule {
    ...
    public static void showSummaryDialog(JFrame owner, List<EmployeeData> employees, List<AttendanceData> attendanceRecords) {
        ...
        JDialog dialog = new JDialog(owner, "Company-Wide Payroll Report", true);
